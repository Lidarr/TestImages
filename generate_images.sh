...
# Preferred versions
MONO_VERSIONS="6.6 6.4 6.0 5.20 5.18"
...
prepOne() {
    ...
    docker build -t lidarr/testimages:mono-$MONO_VERSION --build-arg MONO_VERSION=$MONO_VERSION --build-arg MONO_URL=$MONO_URL --file mono/complete/Dockerfile mono
}
